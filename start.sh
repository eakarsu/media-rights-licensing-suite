...
PORT="${PORT:-5790}"
DB_NAME="${PGDATABASE:-media_rights_licensing_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Media Rights Licensing Suite"
echo "======================================="
echo
...
echo "Starting media rights licensing suite frontend on http://localhost:$PORT"
echo "Login: admin@media-rights-licensing.local / admin123"
