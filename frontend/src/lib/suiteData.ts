...
export const sourceSystems = [
  { name: 'AIMediaRightsLicensingAssistant', ownership: 'Projects source capabilities and workflows', coverage: ['Projects', 'Assets', 'Calendar'] },
  { name: 'AIMediaRightsLicensingOperations', ownership: 'Assets source capabilities and workflows', coverage: ['Scripts', 'Approvals', 'Rights'] },
  { name: 'AIMediaRightsLicensingAnalytics', ownership: 'Calendar source capabilities and workflows', coverage: ['Publishing', 'Campaigns', 'Exceptions'] },
  { name: 'AIMediaRightsLicensingWorkflow', ownership: 'Scripts source capabilities and workflows', coverage: ['Performance', 'Analytics', 'Reports'] },
];
