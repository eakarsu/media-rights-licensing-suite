export const AUTH_COOKIE = 'media_rights_licensing_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@media-rights-licensing.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@media-rights-licensing.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@media-rights-licensing.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
