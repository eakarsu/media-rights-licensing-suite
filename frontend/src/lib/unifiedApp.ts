...
const features = [
  {
    ...
    summary: 'Projects workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Content',
    icon: Users,
    summary: 'Assets workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Content',
    icon: ClipboardList,
    summary: 'Calendar workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Content',
    icon: CalendarCheck,
    summary: 'Scripts workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Approvals workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Rights workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Publishing workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Campaigns workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Exceptions workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Performance workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Analytics workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Media Rights Licensing suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Media Rights Licensing documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Media Rights Licensing alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Media Rights Licensing source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Media Rights Licensing users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Media Rights Licensing assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIMediaRightsLicensingAssistant', 'AIMediaRightsLicensingOperations where applicable'],
