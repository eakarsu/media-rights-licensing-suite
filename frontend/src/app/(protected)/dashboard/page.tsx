...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Media Rights Licensing Dashboard"
      subtitle="One merged media rights licensing view for Projects, Assets, Calendar, Scripts, Approvals, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared media rights licensing jobs into one surface. Projects, Assets, Calendar, Scripts, Approvals, Rights, documents, audit, and AI are presented as platform features.</div>
