const baseUrl = process.env.SMOKE_BASE_URL || 'http://127.0.0.1:5790';
...
const adminCookie = await login('admin@media-rights-licensing.local', 'admin123');
const managerCookie = await login('manager@media-rights-licensing.local', 'manager123');
const analystCookie = await login('analyst@media-rights-licensing.local', 'analyst123');
